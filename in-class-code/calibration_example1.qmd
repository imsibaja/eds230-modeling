...
source(here("in-class-code/R/compute_highflowmetrics.R"))
...
# or with observed but focus on feb flow
...
mean_feb_obs = mean(subset(msagel_mth, month==2)$obs) 
ggplot(subset(msagel_mth, month==2), aes(accept, str))+geom_boxplot()+
  geom_hline(yintercept=mean_feb_obs, col="red")+labs(y="Streamflow", x="Date")
```
