...
```{r valuep, echo=TRUE}
source(here("discussions", "w3", "data", "compute_NPV.R"))
source(here("discussions", "w3", "data", "compute_profit_frompower.R"))
...
load(here("discussions", "w3", "data", "sierraczosolar.rda"))
solar_annual_elect <- sierraczosolar
